...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Kamadhenu Silks | Pure Kanchipuram Silk Sarees Since 1992" },
      { property: "og:description", content: "Discover authentic Kanchipuram silk sarees at Kamadhenu Silks. Since 1992, we offer bridal, wedding, and traditional silk sarees crafted with premium quality." },
